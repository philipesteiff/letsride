...
class EspressoDaggerMockRule : DaggerMockRule<ApplicationComponent>(
    ApplicationComponent::class.java, AppModule()) {
  init {
    customizeBuilder { builder: ApplicationComponent.Builder ->
